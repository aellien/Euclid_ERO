...
extent_sep = 0.   # Ratio n_pix/vignet under which the Haar wavelet is used for restoration
ecc_sep = 1.0      # Eccentricity threshold over which the Haar wavelet is used for restoration
