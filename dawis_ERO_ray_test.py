...
infile_list = [os.path.basename(x) for x in glob.glob(os.path.join(indir, 'Euclid-NISP-?-ERO-Abell2390-LSB.DR3.crop.synth.cirrus_lvl5.bkg_sub.input.fits'))]
outdir = '/n03data/ellien/Euclid_ERO/Euclid-NISP-Stack-ERO-Abell2390.DR3/wavelets/out12/'
